...
docker build -t us-central1-docker.pkg.dev/winter-cogency-307316/circleci-registry/test:1.0.0 .

gcloud docker -- push us-central1-docker.pkg.dev/winter-cogency-307316/circleci-registry/test:1.0.0
